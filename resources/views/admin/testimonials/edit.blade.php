...
@section('breadcrumb', 'Testimoni / Edit')

@section('content')
<div class="adm-page-header">
    <div>
        <h1 class="adm-page-title">Edit Testimoni</h1>
        <p class="adm-page-subtitle">{{ $testimonial->client_name }}</p>
    </div>
        ...
        <div class="adm-card">
            ...
            <div class="adm-card-body">
                ...
                <div class="adm-form-group" style="margin-bottom:0;">
                    <label class="adm-label" for="testimonial_content">Isi Testimoni <span class="req">*</span></label>
                    <textarea id="testimonial_content" name="testimonial" class="adm-textarea"
                        style="min-height:160px;" required>{{ old('testimonial', $testimonial->testimonial) }}</textarea>
                ...
                <div class="adm-card-body">
                    <div class="adm-img-preview">
                        @if($testimonial->client_photo)
                            <img id="photo-preview-img"
                                ...
                                alt="{{ $testimonial->client_name }}" style="display:block;">
                    ...
                    <div class="adm-form-group" style="margin-top:0.75rem; margin-bottom:0;">
                        <label class="adm-label" for="photo-input">
                            {{ $testimonial->client_photo ? 'Ganti Foto' : 'Upload Foto' }}
                        </label>
            ...
            <div class="adm-card">
                ...
                <div class="adm-card-body">
                    <div class="adm-form-group">
                        ...
                        <div style="font-size:0.82rem; color:var(--text-muted);">{{ $testimonial->created_at->format('d M Y, H:i') }}</div>
                    </div>
                    <div class="adm-form-group">

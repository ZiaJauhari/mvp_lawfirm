        ...
        <div class="w-full mx-auto px-6 md:px-12 lg:px-16">
            <div class="flex justify-between h-20 items-center gap-8">
                ...
                <a href="{{ route('home') }}" class="flex items-center group shrink-0" aria-label="MVP Law Firm - Beranda">
                    <img src="{{ asset('images/primary-horizontal.png') }}" alt="MVP Law Logo" class="h-11 md:h-12 w-auto object-contain transition-all duration-300 group-hover:opacity-80">
                </a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="lg:col-span-1">
                    <a href="{{ route('home') }}" class="flex items-center mb-5 group">
                        <img src="{{ asset('images/primary-horizontal.png') }}" alt="MVP Law Logo" class="h-12 w-auto object-contain">
                    </a>
